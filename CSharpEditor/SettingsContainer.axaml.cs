...
namespace CSharpEditor
{
    internal partial class SettingsContainer : UserControl
    {
        ...
        public SettingsContainer(Shortcut[] additionalShortcuts)
        {
            ...
            {
                int newInterval = (int)Math.Round(this.FindControl<NumericUpDown>("AutosaveIntervalBox").Value ?? 10) * 1000;
            ...
            {
                int newInterval = (int)Math.Round(this.FindControl<NumericUpDown>("CompilationTimeoutBox").Value ?? 400);
