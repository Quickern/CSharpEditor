...
namespace CSharpEditor
{
    internal class CSharpSourceEditor : Control, ILogicalScrollable
    {
        ...
        {
            Avalonia.Media.FormattedText fmt = new Avalonia.Media.FormattedText("m", System.Globalization.CultureInfo.InvariantCulture, FlowDirection.LeftToRight, Typeface, _fontSize, Brushes.Black);
            this.CharacterWidth = fmt.Width;
        }
        ...
        protected override async void OnKeyDown(KeyEventArgs e)
        {
            ...
            if (!e.Handled)
            {
                ...
                else if (e.Key == Key.F && e.KeyModifiers == Utils.ControlCmdModifier)
                {
                    ...
                    UpdateSearchResults();
                    await Dispatcher.UIThread.InvokeAsync(() => { this.SearchReplace.SearchBox.Focus(); }, DispatcherPriority.Input);
                    e.Handled = true;
                }
