    ...
    internal class CSharpSourceEditorLineNumbers : Control, ILogicalScrollable
    {
        ...
        public override void Render(DrawingContext context)
        {
            ...
            using (context.PushClip(new Rect(0, 0, this.Bounds.Width, this.Bounds.Height)))
            {
                ...
                {
                    Avalonia.Media.FormattedText formattedText = new Avalonia.Media.FormattedText((i + 1).ToString(), CultureInfo.InvariantCulture, FlowDirection.LeftToRight, this.Editor.Typeface, this.Editor.FontSize, this.Editor.LineNumbersBrush);
